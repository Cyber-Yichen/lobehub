export default {
  ...
  'betterAuth.signin.passkeyButton': 'Sign in with a passkey',
  'betterAuth.signin.passkeyError': 'Passkey sign-in failed',
  ...
  'profile.passkey.addError': 'Passkey could not be added',
  'profile.passkey.addSuccess': 'Passkey added',
  'profile.passkey.adding': 'Waiting for your device...',
  'profile.passkey.delete.description':
    'Remove "{{name}}"? You will no longer be able to sign in with this device.',
  'profile.passkey.delete.forbidden':
    'Keep at least one way to sign in. Add a password or connect an account before removing this passkey.',
  'profile.passkey.delete.title': 'Remove passkey',
